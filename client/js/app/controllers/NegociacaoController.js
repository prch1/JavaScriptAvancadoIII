...
System.register(['../models/ListaNegociacoes', '../models/Mensagem', '../models/Negociacao', '../helpers/DateHelper', '../helpers/Bind', '../services/NegociacaoService', '../views/MensagemView', '../views/NegociacoesView'], function (_export, _context) {
    "use strict";

    var ListaNegociacoes, Mensagem, Negociacao, DateHelper, Bind, NegociacaoService, MensagemView, NegociacoesView, _createClass, NegociacaoController, negociacaoController;
        ...
        execute: function () {
            ...
            NegociacaoController = function () {
                ...
                _createClass(NegociacaoController, [{
                    ...
                    key: 'orderna',
                    value: function orderna(coluna) {

                        if (this._ordemAtual == coluna) {
                            this._listaNegociacoes.inverteOrdem();
                        } else {
                            this._listaNegociacoes.orderna(function (a, b) {
